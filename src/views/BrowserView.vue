    ...
    <div class="xl:col-span-6 flex flex-col gap-6 px-2">
      ...
      >
        ...
        <div class="relative w-full md:w-80">
          ...
          />
          <span
            class="absolute right-3 top-2.5 text-slate-500 text-base font-mono select-none pointer-events-none"
          >
      ...
      >
        ...
        >
          ...
          >
            <span
              class="text-base font-bold tracking-tight text-white text-center font-mono truncate w-full"
            >
              {{ champ.name }}
            </span>
          </div>
